...
| NFR-5 | AI-USAGE merge bar · DoD | ADR practice ✓; conventional commits + PR discipline ✓; **coverage reporting in CI not yet implemented** | Parser/validator/API-core covered by 106-test suite incl. Testcontainers ✓ but the ≥70% figure is unmeasured in CI — carry-over task P1-W1 (gate waiver) | In progress (coverage gate lands P1-W1) |
